...
Blockly.Generator.prototype.workspaceToCode = function (workspace) {
  ...
  Blockly.Python.codeSections["import"] = "#section.import\nfrom constants import *\nimport board\n";
  Blockly.Python.codeSections["variable"] = "#section.variable\n";
  Blockly.Python.codeSections["declare"] = "#section.declare\n";
  Blockly.Python.codeSections["function"] = "#section.function\n";
  Blockly.Python.codeSections["event"] = "#section.event\n";
  Blockly.Python.codeSections["once"] = "#section.once\n";
  Blockly.Python.codeSections["async"] = "#section.async\n";
  ...
  // patch : pxt.onStart must be the last block in the list
  var listBlocks = workspace.getTopBlocks(true);
  var block = null;
  for (var i = 0; i < listBlocks.length; i++) {
    if (listBlocks[i].type === 'pxt.onStart') {
      block = listBlocks.splice(i, 1)[0];
      break;
    }
  }
  ...
  var globals = [];
  var varName;
  var workspace = codelab.workspace;
  var variables = Blockly.Variables.allUsedVarModels(workspace) || [];
  for (var i = 0, variable; variable = variables[i]; i++) {
    varName = variable.name;
    __variable__(Blockly.Python.variableDB_.getName(varName,
  ...
  // patch : Add import keyword for native block, this is a workaround
  var listCheck = ["random", "math"];
  var tempCode = ""
  tempCode += Blockly.Python.codeSections["import"];
  tempCode += Blockly.Python.codeSections["variable"];
  tempCode += Blockly.Python.codeSections["declare"];
  tempCode += Blockly.Python.codeSections["function"];
  tempCode += Blockly.Python.codeSections["event"];
  tempCode += Blockly.Python.codeSections["once"];
  tempCode += Blockly.Python.codeSections["async"];
  for (var kw = 0; kw < listCheck.length; kw++) {
    if (tempCode.indexOf(listCheck[kw] + ".") > -1) {
      __import__("import " + listCheck[kw]);
    }
  }

  var finalCode = ''; //code + '\n';
  finalCode += Blockly.Python.codeSections["import"];
  finalCode += Blockly.Python.codeSections["variable"];
  finalCode += Blockly.Python.codeSections["declare"];
  finalCode += Blockly.Python.codeSections["function"];
  finalCode += Blockly.Python.codeSections["event"];
  finalCode += Blockly.Python.codeSections["once"];
  finalCode += Blockly.Python.codeSections["async"];
