    ...
    switch (childIn.tagName.toUpperCase()) {
      case 'CATEGORY':
        ...
        if (goog.isString(iconClass)) {
          childOut.setIconClass(this.config_['cssCollapsedFolderIcon'] + ' ' + iconClass);
        }
        var expandedClass = childIn.getAttribute('expandedclass');
        if (goog.isString(expandedClass)) {
          childOut.setExpandedIconClass(this.config_['cssExpandedFolderIcon'] + ' ' + expandedClass);
        }
        var simplyIcon = childIn.getAttribute('icon');
        if (goog.isString(simplyIcon)){
          childOut.setIconClass(this.config_['cssCollapsedFolderIcon'] + ' ' + simplyIcon);
          childOut.setExpandedIconClass(this.config_['cssExpandedFolderIcon'] + ' ' + simplyIcon);
        }
